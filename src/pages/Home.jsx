        ...
        <main className="bg-[url('/images/bg-pokemon.png')] bg-cover bg-center w-full min-h-screen grid justify-center items-center font-home p-3 overflow-hidden">
            <section className="bg-white/75 w-11/12 mx-auto border-8 border-black relative grid gap-4 rounded-[3rem] pb-36 pt-10 px-6 justify-center">
                ...
                <img
                    ...
                    alt="logo pokedex"
                    className="p-4 sm:w-1/2 sm:mx-auto "
                />
                <h2 className="font-semibold text-center text-2xl">
                    Hello trainer!
                </h2>
                <form onSubmit={handleSubmit} className="grid gap-6 place-items-center">
                    <input
                        type="text"
                        name="trainerName"
                    ...
                    <button
                        type="submit"
                        className="font-semibold bg-[#FF6B57] w-[150px] rounded-lg p-2 sm:w-[300px]"
                    >
                        Start!
                    </button>
                </form>
